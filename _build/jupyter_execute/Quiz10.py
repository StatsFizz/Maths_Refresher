...
Write the arithmetic mean of the data, $\overline{y}$, in terms of $\tilde{x}$.

Choose the correct answer:

1. $\overline{y} = \tilde{x}$
2. $e^\overline{y} = \tilde{x}$
3. $\overline{y} = log(\tilde{x})$
4. $e^\overline{y} = e^\tilde{x}$
